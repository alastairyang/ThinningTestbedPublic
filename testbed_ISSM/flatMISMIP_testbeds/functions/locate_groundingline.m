function x_dist = locate_groundingline(md,mask)
%LOCATE_GROUNDINGLINE find the grounding line distance to x = 0 from
%MaskOceanLevelset
%
%   Input:
%       md   [ISSM class]: ISSM model class
%       mask [double array]: ice or ocean levelset mask
%
%   Output:
%       x_dist [double]: distance to the grounding line from x = 0 (left)
