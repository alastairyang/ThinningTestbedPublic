...
gauss_perturb_analysis(perturb_md, nopertb_md, n_gcp)


%% APPENDIX: functions
function gauss_perturb_analysis(perturb_md, nopertb_md, n_gcp)
    ...
    decay_parm = fminsearch(@minimize_attenuation, decay_v, options, A0, dist_to_perturb, peaks_downstream);
    % plot the attenuation model and the data
    plot_attenuation(decay_parm, A0, dist_to_perturb, peaks_downstream)
end
