...
max_stress_grounded = 5e5; % 1 mPa, 1e6
max_stress_floating = 5e4; % 100 kPa, 1e5
...
% time
tic
tbl_filename = 'runtime_table.csv';
for jj = 6
    ...
    for steps = 1:3
        ...
        if perform(org, 'Transient_Steadystate_Extended') % {{{1  STEP 3
            ...
            md.timestepping.final_time = md.timestepping.start_time + 40;
